...
const translations = {
  en: {
    ...
    brand_strategy_title: "02. Brand Strategy",
    brand_strategy_text:
    ...
    visual_identity_title: "03. Visual Identity",
    ...
    packaging_design_title: "04. Packaging Design",
    packaging_design_text:
    ...
    // La Llorona process (reuses some, adds new ones)
    llorona_research:
    ...
    concept_development: "01. Concept Development",
    concept_development_desc:
    ...
    typography_color: "03. Typography & Color",
    typography_color_desc:
    ...
    layout_design: "04. Layout Design",
    layout_design_desc:
    ...
    visual_identity_cerditos: "04. Visual Identity & Packaging",
    visual_identity_cerditos_text:
  ...
  es: {
    ...
    brand_strategy_title: "02. Estrategia de Marca",
    brand_strategy_text:
    ...
    visual_identity_title: "03. Identidad Visual",
    visual_identity_text:
    ...
    packaging_design_title: "04. Diseño de Empaque",
    packaging_design_text:
    ...
    concept_development: "01. Desarrollo de Concepto",
    concept_development_desc:
    ...
    grid_system: "02. Sistema de Cuadrícula",
    grid_system_desc:
    ...
    typography_color: "03. Tipografía y Color",
    typography_color_desc:
    ...
    layout_design: "04. Diseño de Diseño",
    layout_design_desc:
    ...
    visual_identity_cerditos: "04. Identidad Visual y Empaque",
    visual_identity_cerditos_text:
